...
app.post('/api/reviews', (req, res) => {
  ...
  //It is Destructuring the product, review and username in reqest.body
  //So we can use it in a meaningfull way
  ...
  // then the variable for the object we will save
  // the produc, reveiw and username is needed are required properties
