...
app.get('/read', (req, res) => {
  db.collection('letterList')
    ...
    .skip(1)
    //in mongoDb cursor is a pointer to the result set, it means that the result set is not returned all at once, but in batches. method to change a query result set, such as limit(), sort(), skip(), etc. toarray() method returns an array that contains all the documents in a collection.
    .limit(10)
    .toArray((err, results) => {
