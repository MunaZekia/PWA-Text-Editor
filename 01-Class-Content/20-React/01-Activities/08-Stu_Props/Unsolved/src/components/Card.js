...
export default function Card(props) {
  // props is an object that contains all the data that was passed down from the parent component.
  // in another word props also means properties.
  //we need to pass props as an argument to the function.
  const cardStyle = {
    width: '18rem',
}
